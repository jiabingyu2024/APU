...
\
  ...
  set APU_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:APU:1.0 APU_0 ]

  # Create interface connections
  connect_bd_intf_net -intf_net axi_ahblite_bridge_0_M_AHB [get_bd_intf_pins axi_ahblite_bridge_0/M_AHB] [get_bd_intf_pins APU_0/ahb]
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M00_AXI [get_bd_intf_pins smartconnect_0/M00_AXI] [get_bd_intf_pins axi_ahblite_bridge_0/AXI4]

  # Create port connections
  connect_bd_net -net Net [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins axi_ahblite_bridge_0/s_axi_aclk] [get_bd_pins APU_0/clk]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins axi_ahblite_bridge_0/s_axi_aresetn] [get_bd_pins APU_0/nRst]
  ...
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs APU_0/ahb/RAM_SPACE] -force
